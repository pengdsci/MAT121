...
<font color = "red">Note that the App requires the **standard deviation of the sample**. If you are given the sample variance, you need to take square of it to get the standar deviation.</font>
